document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleDonation = async () => {
        ...
        try {
            const response = await fetch('https://swagger-nextjs-one.vercel.app/api/payment/qris', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    qris_statis: "00020101021126570011ID.DANA.WWW011893600915379619180302097961918030303UMI51440014ID.CO.QRIS.WWW0215ID10243606413760303UMI5204481453033605802ID5915TOKO DINZ STORE6015Kota Pekalongan61055114163048AD1"
                })
            });
            ...
            if (response.ok) {
                ...
                alert(`Error generating QRIS: ${errorData.message || 'Unknown error'}`);
                hideModal();
            }
        } catch (error) {
            alert('Failed to generate QRIS. Please check your connection and try again.');
            hideModal();
        }
    };
